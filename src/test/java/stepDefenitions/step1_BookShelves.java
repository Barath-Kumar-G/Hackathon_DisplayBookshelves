...
public class step1_BookShelves {
	...
	public void the_user_searches_for_bookshelves_and_handles_popup() throws IOException {
		...
		ul=new HomePage(BaseClass.getDriver());
	...
	public void user_selects_the_price_margin_using_slider_and_category_using_dropdown() throws InterruptedException {
		Thread.sleep(2000);
		bs.price();
		Thread.sleep(2000);
	    bs.category();
	...
	public void user_fetches_the_product_details() throws InterruptedException, IOException {
		Thread.sleep(5000);
		bs.productDetails();
	}
}
